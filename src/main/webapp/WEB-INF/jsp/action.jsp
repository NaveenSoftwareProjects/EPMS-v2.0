...
Descripition	:HPCL EMS application action page.
...
function formSubmit(){
	...
	var text=$("#text").val();
       ...
       function getDetails(status){
    	   ...
    	   ({
    	   type: "GET",
    	   url: "ajaxActions.htm?page=AM3&status="+status,
    	   dataType:"json",
    	   success: function(data)
    	   {
    		   $("#bootstrap-table").empty();
    		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Action ID</th><th width='20%'>Action Name</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
					...
					<li class="dropdown">
						<h5>
							<a href="home.htm">Home&nbsp;/&nbsp;</a><a
								...
								href="actions.htm?page=AM1&operation=0&status=A">Roles</a>
...
<div class="row" id="divEMSPageHeaderTitle">
	...
	<div class="row ">
		<div class="col-lg-12">
			<h5>
				<a href="login.htm">Home&nbsp;/&nbsp;</a><a
					href="menu4.htm?url=homeadmin.htm">Administration&nbsp;/&nbsp;</a><a
					href="actions.htm?page=AM3&operation=0&status=A">Actions</a>
			</h5>
			<h1 class="page-header-title">Actions</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<div class="row">
		<div class="col-lg-12 col-md-6">
			...
			<div class="modal fade" id="myModal" data-refresh="true" role="dialog">
						...
						<div class="modal-body">
							<form:form name="form1" class="form-inline" role="form">
								<div class="form-group  popup-form-align">
									<label for="name"> <span> Action Name </span> <input
										type="text" name="description" class="form-control" id="text"
										placeholder="Enter Action" onkeydown="clearData()"></label>
									<div id="alert"></div>
									<input type="hidden" id="page" name="page" value="AM3">
					...
					<div class="modal-body">
						<div class="form-group  popup-form-align del-popup-button">
							...
							<form:form class="form-inline" action="actions.htm" method="post"
								...
								<input type="hidden" name="page" value="AM3">
								<input type="hidden" name="operation" value="3">
								<input type="hidden" id="message" name="actionID">
								<button type="submit"
...
<div class="modal fade" id="myModalupdate" role="dialog">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="content-header">
				<h4>Update Action</h4>
				<a class="close" id="closebtn" data-dismiss="modal"><img
					src="<c:url value="/resources/images/close.png" />" width="35"></a>
			</div>
			<div class="modal-body">
				...
				<form:form class="form-inline" action="actions.htm" method="post"
					...
					<div class="form-group  popup-form-align">
						<label for="name"> <span>Action Name </span> <input
							...
							placeholder="Action" onload="getValue()"></label>
						<div id="upalert"></div>
						<input type="hidden" name="page" value="AM3"> <input
							type="hidden" name="operation" value="2"> <input
							type="hidden" name="actionID" id="actionID">
						<button type="submit"
							class="btn  btn-sm btn-primary popup-form-button-align"
