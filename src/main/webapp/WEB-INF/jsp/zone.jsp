...
function formSubmit(){
	...
	var text=$("#text").val();
       ...
       function getDetails(status){
    	   ...
    	   ({
    	   type: "GET",
    	   url: "ajaxActions.htm?page=AM5&status="+status,
    	   dataType:"json",
    	   cache:false,
    	   success: function(data)
    	   {
    		 if(data.details==""){
    			   ...
    			   if(status == 'I' || status=='all'){
    				   $("#bootstrap-table").empty();
            		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Zone ID</th><th width='20%'>Zone Name</th><th width='20%'>Status</th></thead>";
            		   var head_data1="<thead><tr><th width='10%'>SNo</th><th width='20%'>Zone ID</th><th width='20%'>Zone Name</th><th width='20%'>Status</th></thead>";
            		   $(head_data).appendTo("#bootstrap-table");
    			   ...
    			   $("#bootstrap-table").empty();
        		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Zone ID</th><th width='20%'>Zone Name</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
        		   var head_data1="<thead><tr><th width='10%'>SNo</th><th width='20%'>Zone ID</th><th width='20%'>Zone Name</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
        		   $(head_data).appendTo("#bootstrap-table");
        		   $(head_data1).appendTo("#bootstrap-table");
        		   ...
        		   $("#bootstrap-table").empty();
        		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Zone ID</th><th width='20%'>Zone Name</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
        		   var head_data1="<thead><tr><th width='10%'>SNo</th><th width='20%'>Zone ID</th><th width='20%'>Zone Name</th><th width='20%'>Status</th><th width='20%'> </th></thead>";
        		   $(head_data).appendTo("#bootstrap-table");
        		   $(head_data1).appendTo("#bootstrap-table");
...
<div id="page-wrapper">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 breadcrumbs-left"
				...
				<ul class="nav navbar-top-links navbar-left">
					<li class="dropdown">
						...
						<a href="actions.htm?page=AM5&operation=0&status=A" class="left-breadcrumb-last-child">Zones</a>
						</h5>
					</li>
				</ul>
			</div>

			<div class="col-lg-6 col-md-6 breadcrumbs-right" id="divEMSnavRight">
				<div class="row">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header-title">Zone</h1>
		</div>
	</div>
 <div class="">
				...
				<div class="modal-body">
					...
					<div class="form-group hpclusers-popup">
								...
								<div class="devices-test">
									<label for="name"> Zone Name <b>*</b></label> <input
							type="text" name="description" class="form-control" id="text"
							placeholder="Enter Zone" onkeydown="clearData()">
									<div id="alert" class="alert-message"></div>
								</div>
								
							<div class="clear"></div>	
						<input type="hidden" id="page" name="page" value="AM5"> <input
				...
				<div class="modal-body">
					...
					<div class="form-group  popup-form-align del-popup-button">
						...
						<form:form class="form-inline" action="actions.htm" method="post"
							...
							<input type="hidden" name="page" value="AM5">
							<input type="hidden" name="operation" value="3">
							<input type="hidden" id="message" name="zoneID">
							<button type="button" data-dismiss="modal"
				...
				<div class="modal-body">
					...
					<form:form class="form-inline" action="actions.htm" method="post"
						...
						<div class="form-group hpclusers-popup">
								...
								<div class="devices-test">
									<label for="name">Zone Name <b>*</b> </label>
									<input type="text" name="description" class="form-control"
								id="usertext" placeholder="Action" onload="getValue()" onkeydown="clearData()"></input>
							<div id="upalert" class="alert-message"> </div>
								</div>
								<div class="clear"> </div>
								<input type="hidden" name="page" value="AM5"> <input
								type="hidden" name="operation" value="2"> <input
								type="hidden" name="zoneID" id="zoneID">
								<button type="button" data-dismiss="modal"
...
<script>
              ...
              {           	              
                if(formValidation(document.getElementById("text"),document.getElementById("alert"))){
                	var text=$("#text").val();
                	 $.ajax({
            		     url:"validation.htm?page=AMUD3&description="+text,
            		   	 dataType:"json",
            		   	 cache:false,
            		   	 async:false,
            		     success: function (data) {
