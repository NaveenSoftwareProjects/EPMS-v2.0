...
if(text==""){
    ...
    function getDetails(status){
    	   ...
    	   ({
    	   type: "GET",
    	   url: "ajaxActions.htm?page=AM1&status="+status,
    	   dataType:"json",
    	   cache:false,
    	   async:false,
    	   success: function(data)
    	   { 
			   ...
			   $("#bootstrap-table").empty();
    		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Role ID</th><th width='20%'>Employee Role</th><th width='20%'>Status</th></thead>";
    		   var head_data1="<thead><tr><th width='10%'>SNo</th><th width='20%'>Role ID</th><th width='20%'>Employee Role</th><th width='20%'>Status</th></thead>";
    		   $(head_data).appendTo("#bootstrap-table");
    		   ...
    		   $(".use-confirm").click(function() {
			   ...
			   else
				   {
 				   ...
 				   $("#bootstrap-table").empty();
	    		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Role ID</th><th width='20%'>Employee Role</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
	    		   var head_data1="<thead><tr><th width='10%'>SNo</th><th width='20%'>Role ID</th><th width='20%'>Employee Role</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
	    		   $(head_data).appendTo("#bootstrap-table");
	    		   $(head_data1).appendTo("#bootstrap-table");
	    		   ...
	    		   $("#bootstrap-table").empty();
	    		   var head_data="<thead><tr><th width='10%'>SNo</th><th width='20%'>Role ID</th><th width='20%'>Employee Role</th><th width='20%'>Status</th><th width='20%'>Action </th></thead>";
	    		   var head_data1="<thead><tr><th width='10%'>SNo</th><th width='20%'>Role ID</th><th width='20%'>Employee Role</th><th width='20%'>Status</th><th width='20%'>  </th></thead>";
	    		   $(head_data).appendTo("#bootstrap-table");
	    		   $(head_data1).appendTo("#bootstrap-table");
	    		   $.each(data.details, function(i,data){
	    			  var status;
					...
					<ul class="nav navbar-top-links navbar-left">
						<li class="dropdown">
							<h5>
								...
								<a href="actions.htm?page=AM1&operation=0&status=A" class="left-breadcrumb-last-child">Roles</a>
...
<div id="role_error"><center><font color="red"><b ><p id="error_msg"></p> </b></font></center></div> 
	<div class=" ">
		<div class="col-lg-12 col-md-12 search-config-align">
			...
			<table class="table table-hover table-striped bdt"
				id="bootstrap-table">
				...
				<div class="modal-body">
					...
					<div class="form-group hpclusers-popup">
								...
								<div class="devices-test">
									<label for="name"> Role Name <b>*</b> </label><input
							type="text" name="description" class="form-control" id="text"
							placeholder="Enter role Name" onkeydown="clearData()">
									<div id="alert" class="alert-message"></div>
								</div>
								<div class="clear"></div>
								<input type="hidden" id="page" name="page" value="AM1" />
								 <input
					...
					<%--  </form:form> --%>
					<!-- <a class='use-confirm fa fa-trash' href=''#' data-toggle='modal' data-target='#myModaldel'>Delete</a> -->
				</div>
				...
				<div class="modal-body popup-delete-align">
					<div class="form-group  popup-form-align del-popup-button">
						...
						<form:form class="form-inline" action="actions.htm" method="post"
							...
							<input type="hidden" name="page" value="AM1">
	...
	<div class="modal fade" id="myModalupdate" role="dialog">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
                   <form:form class="form-inline" action="actions.htm" method="post"
						modelAttribute="EmployeRoles" onsubmit="return upvalidate()"
						role="form">
						<div class="form-group hpclusers-popup">
                             <div class="devices-test">
							     <label for="name">Employee Role <b>*</b> </label><input
								type="text" name="description" class=""
								id="usertext" placeholder="Page Name" onload="getValue()"
								onkeydown="clearData()">
									<div id="upalert" class="alert-message"></div>
								</div>
								<div class="clear"> </div>
								
								<input type="hidden" name="page" value="AM1"> <input
...
<script>
             ...
             {           	              
               if(formValidation(document.getElementById("text"),document.getElementById("alert"))){
            	   ...
            	   $.ajax({
          		     url:"validation.htm?page=AMUD1&description="+text,
          		   	 dataType:"json",
          		     async:false,
          		   	 cache:false,
	    			 success: function (data) {
     	...
     	$('#btnDelteYes').click(function () {
           ...
           function myFunction() {
        	    var inpObj = document.getElementById("roleid");
