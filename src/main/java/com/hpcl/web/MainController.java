...
/*	@RequestMapping(value="/downloadPDF.pdf", method = RequestMethod.GET)
	public ModelAndView downloadExcel() {
		...
		List<DashboardData> listBooks = new ArrayList<DashboardData>();
		listBooks.add(new DashboardData("Spring in Action", "Craig Walls", "1935182358",
				"June 29th 2011", 31.98F));
		listBooks.add(new DashboardData("Spring in Practice", "Willie Wheeler, Joshua White",
				"1935182056", "May 16th 2013", 31.95F));
		listBooks.add(new DashboardData("Pro Spring 3",
				"Clarence Ho, Rob Harrop", "1430241071", "April 18th 2012", 31.85F));
		listBooks.add(new DashboardData("Spring Integration in Action", "Mark Fisher", "1935182439",
